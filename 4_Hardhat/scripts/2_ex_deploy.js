...
// Your code here!
console.log("Wrapped Ether version:", hre.ethers.version);
...
console.log("Hardhat signer 0 address:", hardhatSigners[0].address);
  ...
  const readContract = async (lockContract = lock) => {
      const contractOwner = newContract.contractOwner
      const contractUnlockTim = newContract.contractUnlockTim
      console.log("Contract Owner:", contractOwner);
      console.log("Contract Unlock Time:", contractUnlockTim);
